   ...
   <header>
    ...
    <main>
          <section>
            ...
            $q = "SELECT * FROM `issuedbooks` WHERE `id` = '$id'";
            $run = mysqli_query($con,$q);
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="head">Author</td>
                                         <td class="head">Issued Date</td>
                                    </tr>';        
                $i = 1;                    
                while ($row = $run->fetch_assoc()){
                    $html.= '<tr>
                            <td class="data">'.$i.'</td>
                            <td class="data">'.$row['title'].'</td>
                            <td class="data">'.$row['ISBN'].'</td>
                            <td class="data">'.$row['Author'].'</td>
                            <td class="data">'.$row['IssuedDate'].'</td>
                        </tr>';
                    $i++;
                } 
