...
<body>
    ...
    <main>
           ...
           <?php 
                ...
                $q = "SELECT * FROM `timetable` WHERE `section` = '$section' AND `class` = '$class'";
                $run = mysqli_query($con,$q);
                ...
                while ($row = $run->fetch_assoc()){
                    $html.= '<tr>
                            ...
                            <td class="data">'.$row['Mon'].'</td>
                            <td class="data">'.$row['Tue'].'</td>
                            <td class="data">'.$row['Wed'].'</td>
                            <td class="data">'.$row['Thr'].'</td>
                            <td class="data">'.$row['Fri'].'</td>
                            <td class="data">'.$row['Sat'].'</td>
                        </tr>';
                    // $i++;
                } 
