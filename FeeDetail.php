        ...
        <?php 
            ...
            if(mysqli_num_rows($run)!=0)
            {
                            ...
                            <table class="table table-striped table-hover">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="head">Transport Due</td>
                ...
                while ($row = $run->fetch_assoc()){
                    $html.= '<tr>
                            <td class="data">'.$i.'</td>
                            <td class="data">'.$row['Month'].'</td>
                            <td class="data">'.$row['Fee'].'</td>
                            <td class="data">'.$row['TransportDues'].'</td>
                            <td class="data">'.$row['Total'].'</td>
                            <td class="data">'.$row['Due'].'</td>
                        </tr>';
                    $i++;
                } 
