...
<body>
        ...
        <div class="navi">
            <nav class="navbar navbar-expand-md  bg-info sticky-top">
                <a class="navbar-brand" href="index.php">
                    <span class=""></span> Scholarship Deatil</a>
    ...
    <main>
            ...
            $q = "SELECT * FROM `scholarship` WHERE `id` = '$id'";
            $run = mysqli_query($con,$q);
            if(mysqli_num_rows($run)>=0)
            {
                ...
                while ($row = $run->fetch_assoc()){     
                    $html.= '<tr>
                            ...
                            <td class="data">'.$row['Grade'].'</td>
                            <td class="data">'.$row['ScholarshipDiscount'].'</td>
                        </tr>'; 
                    }
            ...
            else
            {
                echo '<div class="marquee container">
                        <h1>There is no scholarship! Scholarship is given over 80%</h1>
                    </div>';
            }
            ?>
</table>
    ...
    <script src="https://code.jquery.com/jquery-3.4.1.slim.min.js" integrity="sha384-J6qa4849blE2+poT4WnyKhv5vZF5SrPo0iEjwBvKU7imGFA V0wwj1yYfoRSJoZ+n" crossorigin="anonymous">
	</script>
